...
(function() {
  var CheckIt, EmailField, Field, IntField, StringField, cleanup_function_prototype, enable_validation, field, fields, plugin, polute_function_prototype,
  ...
  IntField = (function(_super) {
    ...
    function IntField(name, options) {
      ...
      if (options.greater_than != null) {
        this.validations.push("greaterThan:" + options.greater_than);
      }
      if (options.greater_than_equal_to != null) {
        this.validations.push("greaterThanEqualTo:" + options.greater_than_equal_to);
      }
      if (options.less_than != null) {
        this.validations.push("lessThan:" + options.less_than);
      }
      if (options.less_than_equal_to != null) {
        this.validations.push("lessThanEqualTo:" + options.less_than_equal_to);
      }
    }
