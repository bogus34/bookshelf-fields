...
(function() {
  var CheckIt, EmailField, Field, FloatField, IntField, NumberField, StringField, cleanup_function_prototype, deep_clone, enable_validation, field, fields, plugin, pollute_function_prototype,
  ...
  plugin = function(instance) {
    ...
    model.validate = function(self, attrs, options) {
      if (!('validate' in options) || options.validate) {
        return CheckIt(this.toJSON()).run(deep_clone(this.validations));
      }
    };
